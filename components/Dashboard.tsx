           ...
           <div className="glass-card w-full max-w-md rounded-[3rem] p-10 shadow-2xl animate-in slide-in-from-bottom duration-500 border-0 bg-surface">
               <div className="flex justify-between items-center mb-8">
                   <div>
                        ...
                        <p className="text-[10px] font-black text-foreground/30 uppercase tracking-widest mt-2">{mainWallet.name} → Dự phòng</p>
                   </div>
                   <button onClick={() => setShowTransferModal(false)} className="p-3 bg-foreground/5 rounded-2xl text-foreground/40"><X size={22} /></button>
               </div>
      ...
      <div className="glass-card liquid-glass rounded-[2.5rem] p-3 bg-gradient-to-r from-primary/10 via-surface/80 to-secondary/10 border-0 shadow-xl">
          <div className="flex items-center justify-between p-5">
              ...
              <button 
                ...
                className="bg-primary text-white px-7 py-4 rounded-[1.5rem] font-[900] text-[10px] uppercase tracking-[0.3em] active:scale-95 transition-all shadow-xl neon-glow-primary"
              >
                  XỬ LÝ
              </button>
          </div>
